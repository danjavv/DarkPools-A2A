...
\newenvironment{functionality}[1][]{\Needspace{4\baselineskip}\par\intfunc[#1]~\vspace{-1em}\begin{mdframed}[style=boxstylewtitle,frametitle={\hspace*{-1.2em}\smash{\raisebox{-0.25em}{\rlap{\colorbox{white}{Functionality \thesection.\arabic{intfunc}. #1\strut~}}}}}]\em}{\end{mdframed}\endintfunc}
