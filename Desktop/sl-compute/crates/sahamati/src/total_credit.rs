...
pub async fn run_total_credit<T, R>(
    setup: &T,
    ...
    R: Relay,
{
    ...
    let credit_values = run_batch_boolean_to_arithmetic(
        setup,
        mpc_encryption,
        tag_offset_counter,
        relay,
    ...
    let mut credit_p = ArithmeticShare::ZERO;
    for v in credit_values {
        credit_p.mut_add_share(&v);
    }
...
// #[cfg(test)]
// mod tests {
//     use super::test_run_total_credit;
//     use crate::process_plaintext_sh::TransactionEntry;
...
//
//         let (total_credit_p1, total_credit_p2, total_credit_p3) = test_run_total_credit(
//             &transac_p1,
//             &transac_p2,
//             &transac_p3,
//             &mut serverstate_p1,
