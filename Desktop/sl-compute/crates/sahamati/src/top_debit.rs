...
pub async fn run_top_debit<T, R>(
    setup: &T,
    ...
    R: Relay,
{
    ...
    let top_debit_p = run_batch_boolean_to_arithmetic(
        setup,
        mpc_encryption,
        tag_offset_counter,
        relay,
...
//
//         let (top_debit_p1, top_debit_p2, top_debit_p3) = test_run_top_debit(
//             &transac_p1,
//             &transac_p2,
//             &transac_p3,
//             &mut serverstate_p1,
